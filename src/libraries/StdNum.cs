...
/// </summary>
[TableScriptLibrary("stdnum.cs")]
public static partial class StdNum{
	...
	/// Gets Pi constant
	/// </summary>
	[TableScriptFunction][Obsolete("Use stdnum::pi global")]
	public static string getPi() => Math.PI.ToStr();
	
	/// <summary>
	/// Gets e (Eulers number) constant
	/// </summary>
	[TableScriptFunction][Obsolete("Use stdnum::e global")]
